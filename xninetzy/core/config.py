...
class Settings(BaseSettings):
    ...
    XNINETZY_THINK_TIMEOUT_SECONDS: int = 120
    XNINETZY_INACTIVITY_TIMEOUT_SECONDS: int = 60
    XNINETZY_TOOL_TIMEOUT_SECONDS: int = 180
    XNINETZY_MCP_CONNECT_TIMEOUT_SECONDS: int = 20
    XNINETZY_MCP_CALL_TIMEOUT_SECONDS: int = 180
    XNINETZY_MCP_TRANSPORT: str = "stdio"
    XNINETZY_MCP_HTTP_HOST: str = "127.0.0.1"
    XNINETZY_MCP_HTTP_PORT: int = 8765
    XNINETZY_MCP_HTTP_PATH: str = "/mcp"
    XNINETZY_DEEP_RESEARCH_TIMEOUT_SECONDS: int = 900
    XNINETZY_STREAM_TIMEOUT_SECONDS: int = 300
    XNINETZY_SLOW_REQUEST_WARNING_SECONDS: int = 45
    ...
    XNINETZY_SKILL_RESOURCE_MAX_BYTES: int = 131_072
    XNINETZY_SKILL_MAX_BODY_LINES: int = 500
    ...
    XNINETZY_SKILL_AUTO_INJECT_USER: bool = False
    ...
    OBSIDIAN_REQUIRE_ORGANIZE_APPROVAL: bool = True
    OBSIDIAN_AUTO_REFRESH_MOC: bool = True
    OBSIDIAN_PERSIST_ACADEMIC_SENSITIVE: bool = False
    OBSIDIAN_LEGACY_PATH_COMPATIBILITY: bool = True
    OBSIDIAN_MIGRATION_BACKUP: bool = True
    ...
    XNINETZY_CAPTCHA_OCR_ENABLED: bool = False
    XNINETZY_CAPTCHA_OCR_MIN_CONFIDENCE: float = 0.6
    XNINETZY_CAPTCHA_OCR_LOCKOUT_THRESHOLD: int = 3
    XNINETZY_CAPTCHA_OCR_LOCKOUT_WINDOW_SECONDS: int = 600
    XNINETZY_CAPTCHA_OCR_COOLDOWN_SECONDS: int = 3600
    ...
    ACADEMIC_SESSION_STALE_HOURS: int = 12
    ACADEMIC_SESSION_WATCHDOG_INTERVAL_SECONDS: int = 1800
    ACADEMIC_SESSION_WATCHDOG_NOTIFY_COOLDOWN_HOURS: int = 6
    ...
    LIGHTNING_REVIEW_ENABLED: bool = False
    LIGHTNING_REVIEW_HOUR: int = 2
    LIGHTNING_REVIEW_INTERVAL_HOURS: int = 24
    LIGHTNING_AUTO_APPLY: bool = False
    LIGHTNING_CODE_FIX_ENABLED: bool = False
    LIGHTNING_PROVIDER_OPTIMIZATION_ENABLED: bool = True
    LIGHTNING_EXPLORATION_RATE: float = 0.10
    LIGHTNING_MIN_SAMPLES_PER_STRATEGY: int = 20
