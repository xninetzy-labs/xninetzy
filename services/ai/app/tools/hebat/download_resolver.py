...
from app.tools.hebat.link_extractor import extract_file_links, looks_like_file_url
...
async def _resource_redirect_target(chat_id: str, url: str) -> DownloadLink | None:
    ...
    from app.tools.hebat.browser_session import get_cookies_for_httpx
    from app.tools.hebat.parsers import is_login_redirect
...
async def resolve_download_links(chat_id: str, activity_url: str) -> list[DownloadLink]:
    ...
    """
    from app.tools.hebat.moodle_client import _get
