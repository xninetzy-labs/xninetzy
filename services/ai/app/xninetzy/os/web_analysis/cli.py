...
def build_parser() -> argparse.ArgumentParser:
    ...
    analyze.add_argument("--site", required=True, choices=("hebat", "mahasiswa", "qa", "uacc"))
    ...
    login.add_argument("--site", required=True, choices=("hebat", "mahasiswa", "qa", "uacc"))
    ...
    status.add_argument("--site", required=True, choices=("hebat", "mahasiswa", "qa", "uacc"))
